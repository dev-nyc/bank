  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
       ...
       <form action="calculate.php" method="post" accept-charset="utf-8" class="form" style="padding: 10px;">
                    <div class="form-group">
                        <label for="">Enter your information</label>
                        <label>Credits <input type="radio" name="addCredit" value=""></label>
                        <label>Debits <input type="radio" name="subCredit" value=""></label> <br>
                        ...
                        <input type="submit" name="submitValue" value="Submit Value" class="btn">
                        <input type="reset" name="" value="Reset" class="btn">
                    </div>
                </form>
      </div>
